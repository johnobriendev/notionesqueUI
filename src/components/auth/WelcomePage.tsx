        ...
        <div className="lg:w-1/2 flex flex-col items-start">
          ...
          <div className="mt-12 flex items-center">
            <div className="flex -space-x-2">
              {[...Array(4)].map((_, i) => (
                <div key={i} className={`h-10 w-10 rounded-full border-2 border-white flex items-center justify-center text-xs font-semibold ${
                  ['bg-pink-500', 'bg-purple-500', 'bg-blue-500', 'bg-green-500'][i]
                }`}>
                  {['JD', 'KM', 'AS', 'TP'][i]}
                </div>
              ))}
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-600">From over 500+ reviews</p>
            </div>
          </div>
        </div>
